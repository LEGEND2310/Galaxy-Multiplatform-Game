...
class MainWidget(Widget):
    ...
    V_NB_LINES = 8
    V_LINES_SPACING = 0.4  #% of screen width 
    vertical_lines = []
    ...
    def update_ship(self):
        ...
        shit_half_width = self.ship_width * self.width / 2
        ship_height = self.ship_height * self.height

        self.ship_coordinates[0] = (center_x - shit_half_width, base_y)
        self.ship_coordinates[1] = (center_x, base_y + ship_height)
        self.ship_coordinates[2] = (center_x + shit_half_width, base_y)
